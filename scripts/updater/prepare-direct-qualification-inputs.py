...
def prepare_inputs(
    *,
    ...
    if (
        candidate.get("version") != "0.6.649"
        or candidate.get("tag") != "v0.6.649"
        ...
        != "biyan/updater/releases/v0.6.649/latest.json"
    ):
        raise ValueError("candidate identity must be exact v0.6.649/C/schema 3")
    require_sha256(
