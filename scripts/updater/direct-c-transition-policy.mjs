...
function validateApprovedNext(value) {
  ...
  if (value.version !== '0.6.649' || value.tag !== 'v0.6.649') {
    throw new Error('DIRECT_C approvedNext must be exact version v0.6.649')
  }
  ...
  if (value.manifestKey !== 'biyan/updater/releases/v0.6.649/latest.json') {
