...
use app_lib::core::cli::{
    ...
    discover_llamacpp_binary, discover_mlx_binary, download_hf_model, fetch_hf_gguf_files,
    init_llamacpp_state, init_mlx_state, list_models, load_llama_model_impl, load_mlx_model_impl,
    looks_like_hf_repo, resolve_model_by_id, resolve_model_engine, HfFileInfo, LlamacppConfig,
    MlxConfig,
};
