...
| --- | --- | --- | --- |
| A | 0.6.640 | 1 | Establish the migration substrate and activate Biyan storage |
| B | 0.6.641 | 2 | Remove retired runtime payloads and finish package branding |
| C | 0.6.642 | 3 | Restrict legacy aliases to isolated ingress and migration code |

The superseded `0.6.634` and `0.6.637` candidates failed before a GitHub
Release was created; their public tags remain immutable release evidence.
Versions `0.6.635`, `0.6.636`, `0.6.638`, and `0.6.639` were never tagged.
The supported replacement train starts at `0.6.640`.
