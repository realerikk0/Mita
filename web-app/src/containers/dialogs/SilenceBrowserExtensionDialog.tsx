...
export type SilenceBrowserExtensionDialogState =
  | 'closed'
  | 'checking'
  | 'not_installed'

interface SilenceBrowserExtensionDialogProps {
  open: boolean
  onOpenChange: (open: boolean) => void
  state: SilenceBrowserExtensionDialogState
  onCancel?: () => void
}

export default function SilenceBrowserExtensionDialog({
  open,
  onOpenChange,
  state,
  onCancel,
}: SilenceBrowserExtensionDialogProps) {
