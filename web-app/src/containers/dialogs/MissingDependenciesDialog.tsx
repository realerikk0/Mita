...
function getInstallRecommendations(
  ...
  if (bundledLibs.length > 0) {
    ...
    recommendations.push({
      ...
      description:
        'Some core backend files are missing or corrupted — this usually means the download was interrupted or the archive was only partially extracted. Delete the backend and re-download it from Biyan settings.',
      libs: bundledLibs,
    })
  }
