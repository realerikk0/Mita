...
| --- | --- | --- | --- |
| 0.6.611 or later public stable releases | 0.6.649 | 3 | Upgrade automatically and apply the complete Biyan layout, remote-only cleanup, branding, and compatibility migration |
| 0.6.605–0.6.608 | 0.6.649 | 3 | Install the latest package manually; the retired updater hostname and old signing-key generation are not an automatic route |
