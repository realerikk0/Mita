...
| A | 0.6.640 | 1 | Establish Biyan layout and stop retired runtimes |
| B | 0.6.641 | 2 | Remove local/RAG components and finish package branding |
| C | 0.6.642 | 3 | Remove normal-path legacy aliases |

The superseded 0.6.634 and 0.6.637 candidates failed before a GitHub Release was created and are not part of the supported upgrade path. Their tags remain only as release evidence. Versions 0.6.635, 0.6.636, 0.6.638, and 0.6.639 were not released.
