...
| A | 0.6.637 | 1 | Establish Biyan layout and stop retired runtimes |
| B | 0.6.638 | 2 | Remove local/RAG components and finish package branding |
| C | 0.6.639 | 3 | Remove normal-path legacy aliases |

The superseded 0.6.634 candidate failed before a GitHub Release or artifacts were published and is not part of the supported upgrade path. Its tag remains only as release evidence. Versions 0.6.635 and 0.6.636 were not released.
